...
public class DTEmpresa extends DTUsuario {
    ...
    public DTEmpresa(String nickname,  String correo_electronico,  String apellido,  String nombre,  String contraseña,  String descripcion,  String url,  Set<DTOfertaExtendido> dtOfertas,  String imagen) {
