...
public class ControladorUsuarioTest {
	...
	void altaPostulanteTest() {
	 ...
	 assertEquals(true, result1, "Este es el mensaje opcional si la aserción falla");
...
//	 boolean b = 
	...
	// ------------------- datatypes usuario para postulante con imagen -------------------
	 ...
	 assertEquals(true, result2, "El test usu2 fallo");
   }
  ...
  void altaEmpresaTest() throws ExceptionUsuarioNickYCorreoRepetidos {
		    ...
		    assertEquals( result, true, "El test usu3 fallo");
...
//		        boolean b = 
		...
		assertEquals(result2,  true, "El test usu4 fallo");
...
//		boolean b2 = 
		...
		assertEquals(result4,  true, "El test usu4 fallo");
		...
		for (String s : EmpresaSistema) {
			if (!s.equals("Kreves") && !s.equals("Google") && !s.equals("Apple") && !s.equals("Amazon")) {
				assertEquals(false,  true, "El test empresa en sistema fallo");
			}
		}
		...
		assertEquals(true,  booly, "El test validarCredenciales fallo");
