...
public class WebServicesServiceLocator extends org.apache.axis.client.Service implements webservice.WebServicesService {
    ...
    private java.lang.String WebServicesPort_address = "http://localhost:9128/webservices";
    ...
    public webservice.WebServices getWebServicesPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservice.WebServicesPortBindingStub _stub = new webservice.WebServicesPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservice.WebServices.class.isAssignableFrom(serviceEndpointInterface)) {
                webservice.WebServicesPortBindingStub _stub = new webservice.WebServicesPortBindingStub(new java.net.URL(WebServicesPort_address), this);
                _stub.setPortName(getWebServicesPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice/", "WebServicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice/", "WebServicesPort"));
        }
