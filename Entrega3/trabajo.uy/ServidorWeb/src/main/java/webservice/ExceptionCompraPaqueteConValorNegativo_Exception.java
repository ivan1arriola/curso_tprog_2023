 ...
 * 
 */
@WebFault(name = "ExceptionCompraPaqueteConValorNegativo", targetNamespace = "http://webservice/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: webservice.ExceptionCompraPaqueteConValorNegativo
     */
