...
public class ObjectFactory {
    ...
    private final static QName _ExceptionValidezNegativa_QNAME = new QName("http://webservice/", "ExceptionValidezNegativa");
    ...
    /**
     * Create an instance of {@link UsuarioBeanServidor }
     * 
     * @return
     *     the new instance of {@link UsuarioBeanServidor }
     */
    public UsuarioBeanServidor createUsuarioBeanServidor() {
        return new UsuarioBeanServidor();
    }

    /**
     * Create an instance of {@link DateBean }
     * 
     * @return
     *     the new instance of {@link DateBean }
     */
    public DateBean createDateBean() {
        return new DateBean();
    }

    /**
     * Create an instance of {@link OfertaLaboralBeanServidor }
     * 
     * @return
     *     the new instance of {@link OfertaLaboralBeanServidor }
     */
    public OfertaLaboralBeanServidor createOfertaLaboralBeanServidor() {
        return new OfertaLaboralBeanServidor();
    }
    ...
    /**
     * Create an instance of {@link PaqueteBeanServidor }
     * 
     * @return
     *     the new instance of {@link PaqueteBeanServidor }
     */
    public PaqueteBeanServidor createPaqueteBeanServidor() {
        return new PaqueteBeanServidor();
    }

    /**
     * Create an instance of {@link CantTipoPublicacionBeanServidor }
     * 
     * @return
     *     the new instance of {@link CantTipoPublicacionBeanServidor }
     */
    public CantTipoPublicacionBeanServidor createCantTipoPublicacionBeanServidor() {
        return new CantTipoPublicacionBeanServidor();
    }

    /**
     * Create an instance of {@link PostulacionBean }
     * 
     * @return
     *     the new instance of {@link PostulacionBean }
     */
    public PostulacionBean createPostulacionBean() {
        return new PostulacionBean();
    }
    ...
    /**
     * Create an instance of {@link ListaBean }
     * 
     * @return
     *     the new instance of {@link ListaBean }
     */
    public ListaBean createListaBean() {
        return new ListaBean();
    }
     ...
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "ExceptionCantidadRestanteDeUnTipoDeOfertaEnUnPaqueteEsNegativa")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "ExceptionCompraPaqueteConValorNegativo")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "ExceptionRemuneracionOfertaLaboralNegativa")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "ExceptionValidezNegativa")
