 ...
 * 
 */
@WebFault(name = "ExceptionCantidadRestanteDeUnTipoDeOfertaEnUnPaqueteEsNegativa", targetNamespace = "http://webservice/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: webservice.ExceptionCantidadRestanteDeUnTipoDeOfertaEnUnPaqueteEsNegativa
     */
