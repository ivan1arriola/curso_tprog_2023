 ...
 */
@WebServlet("/SeleccionarPostulacionAOfertaLaboral")
public class SeleccionarPostulacionAOfertaLaboral extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeleccionarPostulacionAOfertaLaboral() {
        super();
