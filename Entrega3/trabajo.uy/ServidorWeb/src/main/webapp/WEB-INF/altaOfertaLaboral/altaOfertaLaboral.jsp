            ...
            Set<String> tipoPublicaciones = (Set<String>) request.getAttribute("tipoPublicaciones");
                ...
                Set<String> paquetes = (Set<String>) request.getAttribute("paquetes");
                    ...
                    <body>
                        ...
                        <div class="container col-9">
                          ...
                          <div class="container container col-9">
                            <div class="mx-5">
                              ...
                              <form class="form-signin needs-validation" novalidate action="AltaOfertaLaboral"
                                method="POST" enctype="multipart/form-data">

                                <div class="col-12 row mb-2" id="div-nombre-input">
                                  <div class="col-4">
                                ...
                                <div class="col-12 row mb-2">
                                  ...
                                  <div class="col-8">
                                    <textarea class="form-control" id="descripcion" name="descripcion"
                                      placeholder="Descripción" rows="5" required></textarea>
                                ...
                                <div class="col-12 row mb-2">
                                  ...
                                  <div class="col-8">
                                    <input type="number" class="form-control" id="remuneracion" name="remuneracion"
                                      required placeholder="Remuneracion" min=0 />
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12 row mb-2">
                                  ...
                                  <div class="col-8">
                                    <select class="form-control custom-select-validation" id="listadoDepartamentos"
                                ...
                                <div class="col-12 row mb-2">
                                  ...
                                  <div class="col-8">
                                    <input type="text" class="form-control mt-1" id="ciudad" name="ciudad"
                                ...
                                <div class="col-12 row mb-2">
                                  ...
                                  <div class="col-8">
                                    <select class="form-control custom-select-validation" id="listadoPagos"
                                      name="formaPago" required>
                                      <option value="1" selected>Pagar Sin Paquete</option>

                                      <% if (paquetes !=null && !paquetes.isEmpty()){ for (String paquete : paquetes ){
                                        %>
                                  ...
                                  <div class="col-8">
                                    <div id="keywordSelect" class="form-check form-check-inline">
                                      <% if (keys !=null && !keys.isEmpty()) { for (String key : keys) { %>
                                        <div>
                                          <label class="form-check-label" for="keyword_<%= key %>">
                                            <%= key %>
                                          </label>
                                          <input type="checkbox" name="keywords[]" value="<%= key %>"
                                            class="form-check-input" id="keyword_<%= key %>">
                                        </div>
                                        <% } } %>
                                    </div>
                                  </div>
                                ...
                                <section>
                                  ...
                                  <div class="form-group mb-3 " id="div-image-input">
                                    ...
                                    <input type="file" class="form-control" id="image-input" name="imagen"
                                      accept=".jpg" />
                      ...
                      <script> const host = "<%= request.getContextPath() %>"</script>
