	...
	private void initialize() {
        ...
        btnAceptar.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
                try (BufferedReader reader = new BufferedReader(new FileReader("src/datos/Usuarios.csv"))) {
	                String linea;
	                String linea1;
                	String linea2;
	                ...
	                while ((linea = reader.readLine()) != null) {
	                	...
	                	if(tipo.equals("P")) {
	                		try (BufferedReader reader1 = new BufferedReader(new FileReader("src/datos/Usuarios-Postulantes.csv"))) {
		                		reader1.readLine();
	                		...
	                		try (BufferedReader reader2 = new BufferedReader(new FileReader("src/datos/Usuarios-Empresas.csv"))) {
		                		reader2.readLine();
                ...
                try (BufferedReader reader3 = new BufferedReader(new FileReader("src/datos/TipoPublicacion.csv"))) {
                	String linea3;
                	reader3.readLine();
                	...
                	while ((linea3 = reader3.readLine()) != null) {
                		...
                		ICO.altaTipoPublicacionOL(campos3[1], campos3[2], Integer.parseInt(campos3[3]), Integer.parseInt(campos3[4]), Integer.parseInt(campos3[5]), fechaLocal);
                	}
                } catch (IOException e7) {
                	e7.printStackTrace();
                }
                
                try (BufferedReader reader4 = new BufferedReader(new FileReader("src/datos/Keywords.csv"))) {
                	String linea4;
                	reader4.readLine();
                ...
                try (BufferedReader reader5 = new BufferedReader(new FileReader("src/datos/OfertasLaborales.csv"))) {
                	String linea5;
                	reader5.readLine();
                	...
                	while ((linea5 = reader5.readLine()) != null) {
                		...
                		try (BufferedReader reader6 = new BufferedReader(new FileReader("src/datos/Usuarios.csv"))) {
                			String linea6;
                        	reader6.readLine();
                		...
                		try (BufferedReader reader7 = new BufferedReader(new FileReader("src/datos/TipoPublicacion.csv"))) {
                			String linea7;
                        	reader7.readLine();
                		...
                		try (BufferedReader reader8 = new BufferedReader(new FileReader("src/datos/OfertasLaboralesKeywords.csv"))) {
                			String linea8;
                        	reader8.readLine();
                        	while ((linea8 = reader8.readLine()) != null) {
                        		...
                        		if(campos8[0].equals(campos5[0])) {
                        			...
                        			for(int i = 0; i <= kss.length-1; i++) {
		                    			try (BufferedReader reader9 = new BufferedReader(new FileReader("src/datos/Keywords.csv"))) {
		                    				String linea9;
		                    				reader9.readLine();
                ...
                try (BufferedReader reader10 = new BufferedReader(new FileReader("src/datos/Postulaciones.csv"))) {
                	String linea10;
                	reader10.readLine();
                	...
                	while ((linea10 = reader10.readLine()) != null) {
                		...
                		// Hallar usuario
                		try (BufferedReader reader11 = new BufferedReader(new FileReader("src/datos/Usuarios.csv"))) {
                			String linea11;
                        	reader11.readLine();
                		...
                		try (BufferedReader reader12 = new BufferedReader(new FileReader("src/datos/OfertasLaborales.csv"))) {
                			String linea12;
                        	reader12.readLine();
                ...
                try (BufferedReader reader13 = new BufferedReader(new FileReader("src/datos/Paquetes.csv"))) {
                	String linea13;
                	reader13.readLine();
                ...
                try (BufferedReader reader14 = new BufferedReader(new FileReader("src/datos/TiposPublicacionPaquetes.csv"))) {
                	String linea14;
                	reader14.readLine();
                	while ((linea14 = reader14.readLine()) != null) {
                		...
                		try (BufferedReader reader15 = new BufferedReader(new FileReader("src/datos/TipoPublicacion.csv"))) {
                        	String linea15;
                        	reader15.readLine();
                		...
                		try (BufferedReader reader16 = new BufferedReader(new FileReader("src/datos/Paquetes.csv"))) {
                        	String linea16;
                        	reader16.readLine();
