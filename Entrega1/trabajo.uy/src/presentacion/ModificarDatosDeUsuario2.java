...
public class ModificarDatosDeUsuario2 extends JInternalFrame {
     ...
     * Create the frame.
     */
    public ModificarDatosDeUsuario2(ICtrlUsuario icu) {
        ...
        btnAceptar.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		if(nuevoNombre.isEmpty() || nuevoApellido.isEmpty()) {
        			JOptionPane.showMessageDialog(ModificarDatosDeUsuario2.this, "No puede haber campos vacíos.", "ERRROR - Modificar Datos de Usuario", JOptionPane.ERROR_MESSAGE);
        		}
        		else if(!nuevoNombre.matches("[a-zA-Z]+$")) {
        			JOptionPane.showMessageDialog(ModificarDatosDeUsuario2.this, "El nombre solo puede contener letras.", "ERRROR - Modificar Datos de Usuario", JOptionPane.ERROR_MESSAGE);
        		}
        		else if(!nuevoApellido.matches("[a-zA-Z]+$")){
        			JOptionPane.showMessageDialog(ModificarDatosDeUsuario2.this, "El apellido solo puede contener letras.", "ERRROR - Modificar Datos de Usuario", JOptionPane.ERROR_MESSAGE);
        		}
        		else {
            		...
            		if (nicks.contains(nickBuscar))  {
                		...
                		JOptionPane.showMessageDialog(ModificarDatosDeUsuario2.this, "Los datos se han modificado exitosamente", "Modificar Datos de Usuario", JOptionPane.INFORMATION_MESSAGE);
                		setVisible(false);
                		limpiarFormulario();
            		}
            		else {
